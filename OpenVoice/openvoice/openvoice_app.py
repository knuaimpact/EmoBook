...
content = """
<div>
  <strong>If the generated voice does not sound like the reference voice, try a clearer 10-30 second reference sample with minimal background noise.</strong>
